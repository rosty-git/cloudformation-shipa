...
import (
	...
	"github.com/rostislavgit/cloudformation-shipa/plan/internal/shipa"
)
...
func Create(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	plan := convertModel(currentModel)
	raw, _ := json.Marshal(plan)
	err = client.CreatePlan(context.Background(), plan)
	if err != nil {
...
func Read(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	_, err = client.GetPlan(context.Background(), *currentModel.Name)
	if err != nil {
		return handler.ProgressEvent{}, err
	}
...
func Delete(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	err = client.DeletePlan(context.Background(), *currentModel.Name)
	if err != nil {
		return handler.ProgressEvent{}, err
	}
